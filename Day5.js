    ...
    while(opcode !== 99 && cursor <= inputTmp.length) {
        ...
        switch(opcode) {
            ...
            case 2:
                ...
                break;
            case 3:
                inputTmp[indexes.A] = value;
                cursor += 2;
                break;
            case 4:
                console.log(inputTmp[indexes.A]);
                cursor += 2;
                break;
            case 5:
